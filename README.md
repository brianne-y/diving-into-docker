...
<p align="center">
  <img src="images/docker-mascot-image.png" alt="Diving Into Docker" width="600"/>
</p>
...
| [Lab 02 — Docker Run](labs/lab-02-docker-run.md) | Port mapping, volume mounting, detached mode, interactive mode | 📋 Planned |
| [Lab 03 — Docker Images](labs/lab-03-docker-images.md) | Dockerfile, building images, tagging, layering, docker build | 📋 Planned |
